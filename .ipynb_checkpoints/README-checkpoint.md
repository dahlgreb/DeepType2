...
- Implement:
docker build -t deeptype2 .

- Activation:
docker run -it --rm --runtime=nvidia -v $PWD:/current -v $HOME/knowledgelib/pyknowledge:/current/pyknowledge -u $(id -u) -v /large/large -v /raid:/raid -v /disk:/disk -t deeptype2
